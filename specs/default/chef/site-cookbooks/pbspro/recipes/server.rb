...
# ignored_queues = []
# Chef::Log.info("ignore_workq value: #{ignore_workq}")
# if ignore_workq
#   Chef::Log.info("ignore_workq value again: #{ignore_workq}")
...
#     action :install
#   end
#   Chef::Log.info("in yum package")
# else
#   package package_name do
#     source "#{node['jetpack']['downloads']}/#{package_name}"
#     action :install
#   end
#   Chef::Log.info("in normal package")
# end
