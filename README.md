...
First, download the installer pkg from GitHub. For example, you can download the [2.0.10 release here](https://github.com/Azure/cyclecloud-pbspro/releases/download/2.0.10/cyclecloud-pbspro-pkg-2.0.10.tar.gz)

```bash
# Prerequisite: python3, 3.6 or newer, must be installed and in the PATH
wget https://github.com/Azure/cyclecloud-pbspro/releases/download/2.0.10/cyclecloud-pbspro-pkg-2.0.10.tar.gz
tar xzf cyclecloud-pbspro-pkg-2.0.10.tar.gz
