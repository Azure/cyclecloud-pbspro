...
1. Users must provide Altair PBS Professional binaries 

  * pbspro-client-2022.1.1.el8.x86_64.rpm
...
$ azcopy cp pbspro-client-2022.1.1.el8.x86_64.rpm https://<storage-account-name>.blob.core.windows.net/cyclecloud/blobs/pbspro/
$ azcopy cp pbspro-execution-2022.1.1.el8.x86_64.rpm https://<storage-account-name>.blob.core.windows.net/cyclecloud/blobs/pbspro/
$ azcopy cp pbspro-server-2022.1.1.el8.x86_64.rpm https://<storage-account-name>.blob.core.windows.net/cyclecloud/blobs/pbspro/
```
...
```ini
        ...
        Config.Entries := {[Label="Altair PBS Pro 2022.1"; Value="2022.1.1"]}
